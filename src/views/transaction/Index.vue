    ...
    <div class="row justify-content-center">
      <div class="col-8">
        <router-link
          ...
          class="btn btn-primary btn-sm rounded shadow mb-3">Add
        </router-link>
                  ...
                  <td>
                    <div class="btn-group">
                      <router-link
                        ...
                        class="btn btn-sm btn-outline-info" onmouseover="this.style.color='white';" onmouseout="this.style.color='rgb(14, 212, 247)';">Edit
                      </router-link>&nbsp;
                      <button class="btn btn-sm btn-outline-danger pd-5"
